...
if (selectedNote == 'Text Note 1') {
    ...
    WebUI.callTestCase(findTestCase('6_Archive Note/6.2_Successfully archive a checklist'), [('selectedNote') : selectedNote
            , ('dotsOptionSelect') : dotsOptionSelect], FailureHandling.STOP_ON_FAILURE)
}
